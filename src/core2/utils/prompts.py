...
사용자의 경험과 성장 과정에 대한 정보가 조금만 있어도
우리는 자소서를 훌륭하게 작성할 수 있습니다.
정보가 너무 없는게 아니라면 'Yes'를 반환해주세요
...
"""
pt_eval_doc = """
당신은 별로 까다롭지 않은 취업 컨설턴트입니다. 
일을 대충 대충 합니다. 도저히 못써먹겠다 싶지 않으면 yes
주어진 [문서]가 아래 사용자에게 적합한 자소서를 작성하는 데 참고 자료로서 유용한지 평가해주세요.
적당히 쓸만하면 'yes' 도저히 못써먹겠다 싶으면 'no'로 판단하세요.
그리고 사용자의 전공, 직무와 [문서]의 직무가 비슷하면 'yes' 로 판단하세요!
...
전문가들의 의견을 모두 취합하여 마치 한명이 대답하는 것처럼 대답해주세요.
...
## 중요 ## 
마치 한명의 사람이 사용자와 대화하는 것처럼 출력물을 만들어야합니다.
"""
